...
const en = {
  ...
  manageBooking: {
    ...
    subtitle: 'Enter your booking reference or vehicle plate number to review your reservation, request extra days, or finish a pending payment.',
    heroBadge: 'Guest self-service — no account needed',
    formHeading: 'Look up your reservation',
    formIntro: "Enter the booking reference from your confirmation email, or your vehicle's plate number — either one works on its own.",
    steps: [
      { title: 'Enter your details', body: 'Your booking reference or vehicle plate number is all you need.' },
      { title: 'Review your booking', body: 'See your dates, vehicle, locations, and payment status at a glance.' },
      { title: 'Extend or pay', body: 'Request extra days or finish a pending payment, right from this page.' },
    ],
    queryLabel: 'Vehicle Plate / Booking Reference',
    submit: 'Manage my booking',
    checking: 'Checking…',
