...
const en = {
  ...
  nav: {
    ...
    findMyCarDescription: 'Check your booking status',
    manageBookingDescription: 'Extend your rental',
  ...
  hero: {
    slides: [
      {
        title: 'Choose your right ride',
        body: 'From daily essentials to premium comfort, curated for modern Dubai life.',
      },
      {
        title: 'Airport arrivals, made easy',
        body: 'Land, collect your vehicle, and begin your Dubai journey with ease.',
      },
      {
        title: 'Reserve in minutes',
        body: 'Simple online booking, instant confirmation, and smooth support from arrival to return.',
      },
      {
    ...
    body: 'Browse the live fleet, reserve your vehicle, and enjoy a smooth Dubai arrival with airport pickup and flexible city return.',
    cta: 'Book Now',
    slideAlt: {
  ...
  home: {
    ...
    navigator: {
      ...
      tabs: {
        search: { label: 'Search Cars', description: 'Find your ride' },
        manage: { label: 'Manage Booking', description: 'Review a reservation' },
      ...
      manage: {
        ...
        intro: 'Enter your booking reference and last name to access your reservation.',
        ...
        extend: {
          intro: "Choose how many extra days you'd like — our team reviews availability and pricing before anything is confirmed.",
          daysLabel: 'Additional days',
          dayOption: '{{count}} day',
      ...
      contact: {
        heading: 'Contact Bliss Rent',
        intro: 'Reach our support team directly — WhatsApp is fastest for anything about an existing booking.',
        whatsappLabel: 'WhatsApp',
        emailLabel: 'Email',
        morePageLink: 'More ways to reach us',
      },
    },
    premiumHighlights: {
      eyebrow: 'Why travelers choose us',
      title: 'A smoother rental experience built for Dubai arrivals',
      subtitle: 'Everything is designed for speed, clarity, and confidence — with a real 65% luxury and 35% economy mix for every trip.',
      items: [
    ...
    whyChoose: {
      ...
      subtitle: 'A simple, flexible way to move through the city and beyond — with a real 65% luxury and 35% economy fleet mix.',
      items: [
        {
          title: 'Easy booking',
    ...
    featured: {
      ...
      subtitle: 'Browse our economy and luxury fleets below, updated as new vehicles arrive.',
      economy: {
        label: 'Economy Fleet',
        viewAll: 'View all vehicles',
        emptyTitle: 'No economy vehicles listed yet',
        emptyBody: 'Check back soon — our economy fleet is updated regularly.',
      },
      luxury: {
        label: 'Luxury Fleet',
        viewAll: 'View all vehicles',
        emptyTitle: 'No luxury vehicles listed yet',
        emptyBody: 'Check back soon — our luxury fleet is updated regularly.',
      },
    },
    howItWorks: {
      title: 'How it works',
      subtitle: 'Booking your next Dubai drive is simple and seamless.',
      steps: [
        {
        ...
        },
        {
          ...
          body: 'Review the total, confirm, and pay securely online in a few steps.',
        },
      ],
    },
  },
  ...
  searchResults: {
    resultsEyebrow: 'Curated fleet',
    heroTitle: 'Dubai car rental',
  ...
  checkout: {
    ...
    driver: {
      ...
      sameAsCustomerHint: "We'll use the name and phone number from Step 4 — no need to type them again.",
      sameAsCustomerNoName: 'Your name from Step 4',
  ...
  findMyCar: {
    ...
    subtitle: 'Enter your booking reference to check your reservation status, your vehicle, and how many days you have left — no account needed.',
    heroBadge: 'Guest self-service — no account needed',
  },
  bookCar: {
