...
const en = {
  ...
  manageBooking: {
    eyebrow: 'Find my car',
    title: 'Find My Car',
    subtitle: 'Enter your booking reference or vehicle plate number to check your reservation, confirm the status, and request extra days when needed.',
