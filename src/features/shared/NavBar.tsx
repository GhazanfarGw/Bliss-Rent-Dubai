    ...
    >
      <div className="mx-auto flex h-full max-w-7xl items-center justify-between gap-3 px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-2 lg:hidden">
          ...
          <button
            type="button"
            className={'inline-flex h-11 w-11 items-center justify-center rounded-full bg-transparent transition-colors ' + (onDark ? 'text-white hover:bg-white/10' : 'text-brand-gold hover:bg-brand-gold/10')}
      ...
      >
        ...
        >
          <div className="mb-2 flex items-center justify-between border-b border-brand-gold/10 pb-3">
            ...
            <button
              type="button"
              className="inline-flex h-9 w-9 items-center justify-center rounded-full border border-brand-gold/10 bg-white/70 text-brand-gold shadow-none"
              aria-label={t('nav.toggleMenu')}
              onClick={() => setOpen(false)}
            >
